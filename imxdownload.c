...
{	
	printf("I.MX6ULL bin download software for macOS\r\n");
	printf("Edit by:zuozhongkai\r\n");
	printf("Date:2019/6/10\r\n");
	printf("Maintained by: Jesse\r\n");
	printf("Date:2024/4/27\r\n");
	printf("Version:V1.1\r\n");
...
int main(int argc, char *argv[])
{
	...
	int len = sprintf(cmdbuf, "sudo diskutil unmountDisk %s && ", argv[2]);
	sprintf(cmdbuf + len, "sudo dd oflag=sync if=load.imx of=%s bs=512 seek=2",argv[2]);	
